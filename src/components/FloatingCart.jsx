  ...
  return (
    ...
    >
      <div className="relative">
        ...
        {cartCount > 0 && (
          <span className="absolute -top-3 -right-3 bg-red-500 text-white text-xs font-bold rounded-full w-7 h-7 flex items-center justify-center border-2 border-white shadow-lg">
            {cartCount}
          </span>
        )}
      </div>
